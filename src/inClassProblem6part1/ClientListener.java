...
public class ClientListener implements MessageListener, Runnable {
	...
	public static void main(String[] args) {
		ClientListener s = new ClientListener();
	...
	public void startListening() {
		...
		try {
			...
			Topic topic = session.createTopic(VaultServer.TOPIC);
	...
	public void onMessage(Message message) {
		if (message instanceof TextMessage) {
			...
			try {
				System.out.println("Subscriber<clientListener> onMessage(): "+ txtMsg.getText());
